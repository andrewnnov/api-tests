...
public class CreateUserTest extends BaseUITest {
    ...
    public void adminCanCreateUserTest() {
        ...
        new AdminPanelPage().open().createUser(
                        createUserRequestModel.getUsername(),
                        createUserRequestModel.getPassword()).checkAlertMessageAndAccept(BankAlert.USER_CREATED_SUCCESSFULLY.getMessage())
        ...
        CreateUserResponseModel createUser = AdminSteps.getAllUsers().stream()
                .filter(user -> user.getUsername()
                        .equals(createUserRequestModel.getUsername()))
                .findFirst().get();
    ...
    public void adminCannotCreateUserWithInvalidDataTest() {
        ...
        //step 2: admin create user in bank
        new AdminPanelPage().open().createUser(createUserRequestModel.getUsername(),
