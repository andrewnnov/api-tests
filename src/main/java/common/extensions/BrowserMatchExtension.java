...
public class BrowserMatchExtension implements ExecutionCondition {
    ...
    public ConditionEvaluationResult evaluateExecutionCondition(ExtensionContext context) {
        ...
        if (matches) {
            return ConditionEvaluationResult.enabled("Текущий браузер '" + currentBrowser + "' соответствует требованиям теста.");
        }
        return ConditionEvaluationResult.disabled("Текущий браузер '" + currentBrowser + "' не соответствует требованиям теста.");
    }
}
